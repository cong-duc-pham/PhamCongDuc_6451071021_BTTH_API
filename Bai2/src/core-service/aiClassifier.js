...
function heuristicClassify(text) {
  ...
  if (/chua nhan|giao hang.*lau|lau qua|qua lau|cho lau|loi|khieu nai|ho tro|doi tra|that vong|kem|te/.test(normalized)) {
  ...
  if (/hay|tot|dep|ung ho|tuyet|cam on|thich/.test(normalized)) {
